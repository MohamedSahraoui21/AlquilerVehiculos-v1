...
public class VistaTexto extends Vista {
    ...
    //metodos listar
	//todos los clientes van a ser listados depende el nombre y si coincide nombres iguales entonces con el dni el listado
	...
	//todos los vehiculos van a ser listados depende el marca y si coincide marcas iguales entonces con la matricula el listado
	...
	//todos los alquileres van a ser listados depende el nombre y si coincide nombres iguales entonces con el dni el listado
	...
	public void listarAlquileresCliente() {
		...
		try {
			...
			Comparator<Cliente> comparator = Comparator.comparing(Cliente::getNombre)
					.thenComparing(Cliente::getDni);
			listaAlquileresCl.sort(Comparator.comparing(Alquiler::getFechaAlquiler)
					.thenComparing(Alquiler::getCliente, comparator));
			System.out.print(
					listaAlquileresCl.isEmpty() ? "no hay Alquileres para ese cliente" : listaAlquileresCl);
		} catch (IllegalArgumentException | NullPointerException e) {
			System.out.print(e.getMessage());
		}
	}
	...
	public void listarAlquileresVehiculo() {
		try {
			...
			listaAlquileresV.sort(Comparator.comparing(Alquiler::getFechaAlquiler)
					.thenComparing(Alquiler::getVehiculo, comparadorVehiculo));
			System.out.print(listaAlquileresV.isEmpty() ? "no hay Alquileres para ese Vehiculo"
					: listaAlquileresV);
		} catch (IllegalArgumentException | NullPointerException e) {
			System.out.print(e.getMessage());
		}
